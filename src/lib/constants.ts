...
export const PRODUCTS: ProductConfig[] = [
  ...
  {
    key: 'dining_table_set',
    dbField: 'dining_table_set_qty',
    name: 'Bộ bàn ghế ăn đóng sẵn',
    shortName: 'Bàn ghế ăn',
    icon: '🍽️',
    unit: 'bộ',
    description: 'Bộ bàn ăn 4-6 ghế đóng sẵn cho phòng ăn (Bàn ăn mặt đá, gỗ sồi, hiện đại...)',
    defaultQty: 1,
    maxQty: 10,
  },
  {
